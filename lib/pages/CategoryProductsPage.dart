...
class CategoryProductsPage extends StatelessWidget {
  ...
  const CategoryProductsPage({Key? key, required this.categoryIndex}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // Filter products based on category index (simple mapping for this example)
    ...
    ).where((product) => int.parse(product.image.split('/').last.split('.').first) == categoryIndex).toList();
